...
Four specific things to NOT reject:
...
- Phrasing such as "who will win the championships?", "predict who will win the drivers championship", and "who do you think will win the constructors championship?" are all on topic and suggest that the user should be routed to the predictor agent.
